...
ALTER PROC [dbo].stpSpecificationPosMaskUpdate  @SPMID INT,						--первичный ключ
	...
	/*
		...
		описание: Редактирование Позиционного обозначения (номера позиции для элемента)
	...
	*/
	...
	BEGIN
		...
		/*собрать новую строку позиционного обозначения*/
